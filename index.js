...
const UUID = process.env.UUID || '38fd96dc-711e-4e07-9c3c-e0e670ee52a3'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'nz.woairenqi.eu.cc:11111';        // 哪吒v1填写形式: nz.abc.com:8008  哪吒v0填写形式：nz.abc.com
